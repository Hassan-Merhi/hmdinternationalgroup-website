    ...
    return (
      <div className="admin-screen">
        <form className="admin-login" onSubmit={login}>
          <div className="admin-brand">HMD</div>
          <h1>Website administration</h1>
          <p>Private access for managing public website content.</p>
      ...
      <main>
        ...
        <form className="admin-form" onSubmit={save}>
          <section>
            ...
            <label>Hero image URL<input placeholder="Photo uploads will be added next" value={content.heroImageUrl} onChange={(e) => setContent({ ...content, heroImageUrl: e.target.value })} /></label>
          </section>
          <section>
            <h2>About</h2>
          ...
          <section>
            ...
            <label>WhatsApp<input value={content.whatsappPhone} onChange={(e) => setContent({ ...content, whatsappPhone: e.target.value })} /></label>
          </section>
